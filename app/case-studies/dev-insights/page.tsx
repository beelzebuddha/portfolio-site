            ...
            <div className={styles.prose}>
              ...
              <div className={styles.body}>
                <p className={styles.lede}>
                  ...
                  described the bulk of our 3,000+ developers as “full-stack.”
                  One population, one label, one set of assumptions.
                </p>
                ...
                <p className={styles.bodyText}>
                  So I went sideways. I asked designers and project managers —
                  the people who worked closest to developers — who they most
                  liked working with. Then I asked those developers the same
                  question, and kept pulling the thread until I had a pool of
                  45.
                </p>
                <p className={styles.bodyText}>
