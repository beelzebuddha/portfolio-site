            ...
            <div className={styles.prose}>
              ...
              <div className={styles.body}>
                <p className={styles.lede}>
                  ...
                  directors, principals, and VPs. And that leadership viewed bulk of 
                  our 3,000+ developers as “full-stack”. One population, one label, one set of
                  assumptions.
                </p>
                ...
                <p className={styles.bodyText}>
                  So I went sideways, working from the bottom up. I spoke with designers, few team leads, and project
