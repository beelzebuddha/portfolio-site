          ...
          <div className={`container ${styles.inner}`}>
            <div className={styles.body}>
              <p>
                ...
                internal tools and portals for financial services and membership
                organizations — Capital One, Navy Federal, Credit Suisse, AARP —
                where a confusing screen didn&apos;t cost a conversion, it cost
                someone an hour a day for the rest of their tenure. At CGI
                Federal I spent seven years directing UX for public platforms,
                including the Medicare.gov Compare Tools and GSA marketplaces,
                where accessibility and regulatory compliance were the floor
                rather than the finish line. I arrived as a User Experience
                Manager and left as a Consulting Director. Today I lead design
                for Enterprise Developer Experience at Fannie Mae, where 3,000+
                engineers depend on internal platforms nobody asked them to
                adopt.
              </p>
              <p>
              ...
              <p>
                I hold a BFA from Virginia Commonwealth University, a Certified
                Usability Analyst credential from Human Factors International,
                and a Certified Scrum Master certification from Scrum Alliance.
                More recently: Jared Spool&apos;s UX Leadership and Influence
                course, and Data-Driven Design and Advanced Figma with
                DesignLab. I&apos;m a founding member of Fannie Mae&apos;s
                Enterprise Accessibility Council.
              </p>
              <p>
